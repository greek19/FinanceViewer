...
export interface Asset { id:string; name:string; type:AssetType; value:number; invested:number; currency:'EUR'; updatedAt:string; notes?:string; quantity?:number; averageUnitCost?:number; currentUnitPrice?:number; ticker?:string; exchange?:string; marketCurrency?:string; isin?:string }
